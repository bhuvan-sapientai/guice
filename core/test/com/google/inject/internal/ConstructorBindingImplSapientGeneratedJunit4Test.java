...
public class ConstructorBindingImplSapientGeneratedJunit4Test {
    ...
    private final TypeLiteral typeLiteralMock4 = mock(TypeLiteral.class);

    @Rule()
    public ExpectedException thrown = ExpectedException.none();

    //Sapient generated method id: ${a829f733-5ad7-37e6-975c-7d54c0917922}, hash: 5B32236F2185F900A38AF38C031F2B56
    @Ignore()
    @Test()
    public void createWhenCaughtConfigurationExceptionThrowsErrorsException() throws ErrorsException {
        ...
        try (MockedStatic<InjectionPoint> injectionPoint = mockStatic(InjectionPoint.class);
            ...
            injectionPoint.when(() -> InjectionPoint.forConstructorOf((TypeLiteral) any(), eq(false))).thenReturn(injectionPointMock);
            ...
            //Act Statement(s)
            ConstructorBindingImpl.create(injectorImplMock, key, injectionPoint2, object, scopingMock, errors, false, false);
            //Assert statement(s)
            ...
            injectionPoint.verify(() -> InjectionPoint.forConstructorOf((TypeLiteral) any(), eq(false)));
        }
    }
    ...
    //Sapient generated method id: ${e986ddd1-7ddd-303a-ab76-f91ed0663d29}, hash: DB5A7257E3AD0C97AC8F04076DF1F766
    @Ignore()
    @Test()
    public void getInternalDependenciesWhenFactoryConstructorInjectorIsNull() {
        ...
        try (MockedStatic<Dependency> dependency = mockStatic(Dependency.class);
            ...
            Set<InjectionPoint> injectionPointSet = new HashSet<>();
            injectionPointSet.add(injectionPoint2);
            injectionPoint.when(() -> InjectionPoint.forInstanceMethodsAndFields(typeLiteralMock2)).thenReturn(injectionPointSet);
            ...
            Key key = Key.get(java.lang.Object.class);
            java.lang.Object object = new java.lang.Object();
            InjectionPoint injectionPoint3 = InjectionPoint.forConstructor(constructorMock2, typeLiteralMock3);
            InjectionPoint injectionPoint4 = InjectionPoint.forConstructor(constructorMock3, typeLiteralMock4);
            ...
            injectionPoint.verify(() -> InjectionPoint.forInstanceMethodsAndFields(typeLiteralMock2), atLeast(1));
    ...
    //Sapient generated method id: ${12dd5c10-d98c-3d91-abe2-eb3b12f8440a}, hash: 902DCEC2EBD8A329191B6A38FC988179
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${fdcbc929-583c-3917-b38b-28f2ce6a91da}, hash: D9A56701241F064E4D0F2160B5B13DE1
    @Ignore()
    @Test()
    public void getInjectableMembersWhenFactoryConstructorInjectorIsNotNull() {
        ...
        ImmutableSet<InjectionPoint> injectionPointSet2 = ImmutableSet.of();
        //Assert statement(s)
    ...
    //Sapient generated method id: ${261f205f-b8ac-3e98-b23c-f96964059cf8}, hash: 313D2AE068F5B2559BCEDFA46E2D7876
    @Ignore()
    @Test()
    public void getMethodInterceptorsWhenFactoryConstructorInjectorIsNotNull() {
        ...
        ImmutableMap<Method, List<MethodInterceptor>> methodListMethodInterceptorMap = ImmutableMap.of();
        //Assert statement(s)
        assertThat(result, equalTo(methodListMethodInterceptorMap));
    }
