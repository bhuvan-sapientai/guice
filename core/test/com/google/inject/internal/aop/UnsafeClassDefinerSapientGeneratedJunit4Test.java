...
public class UnsafeClassDefinerSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${c5eb5f54-a48c-35ee-be5b-89092ecaf98f}, hash: 72A29B78B03E24A28CD72673B3A41C85
    @Ignore()
    @Test()
    public void tryPrivilegedWhenCaughtThrowable() throws Throwable {
        ...
        try (MockedStatic<AccessController> accessController = mockStatic(AccessController.class)) {
            ...
            accessController.when(() -> AccessController.doPrivileged((PrivilegedExceptionAction) any())).thenReturn(object);
            //Act Statement(s)
            Object result = UnsafeClassDefiner.tryPrivileged(null, "Cannot bind MethodHandles.Lookup.defineHiddenClass");
            //Assert statement(s)
    ...
    //Sapient generated method id: ${9a052eda-62bf-3d86-aaf6-5e48bf073c2c}, hash: B413B74779A1B536292CD10C7441C286
    @Ignore()
    @Test()
    public void tryAccessDefineClassWhenCaughtThrowable() throws Throwable {
         ...
         */
        //Arrange Statement(s)
        ClassDefiner classDefinerMock2 = mock(ClassDefiner.class);
        try (MockedStatic<AccessController> accessController = mockStatic(AccessController.class);
             MockedStatic<UnsafeClassDefiner> unsafeClassDefiner = mockStatic(UnsafeClassDefiner.class, CALLS_REAL_METHODS)) {
            unsafeClassDefiner.when(() -> UnsafeClassDefiner.accessDefineClass(Class.class)).thenReturn(classDefinerMock);
            accessController.when(() -> AccessController.doPrivileged((PrivilegedExceptionAction) any())).thenReturn(classDefinerMock2);
            //Act Statement(s)
            ClassDefiner result = UnsafeClassDefiner.tryAccessDefineClass(Class.class);
            //Assert statement(s)
            assertThat(result, equalTo(UNSAFE_DEFINERMock));
            unsafeClassDefiner.verify(() -> UnsafeClassDefiner.accessDefineClass(Class.class), atLeast(1));
            accessController.verify(() -> AccessController.doPrivileged((PrivilegedExceptionAction) any()), atLeast(1));
        }
    }
