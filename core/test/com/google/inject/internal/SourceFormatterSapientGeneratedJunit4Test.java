...
public class SourceFormatterSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${9d911adc-fa3c-35d4-930b-cc3b4f280052}, hash: FD29F5E42499259D55844101253C9322
    @Test()
    ...
    //Sapient generated method id: ${798eef0d-7ef8-3b4c-a767-a12b48c4b410}, hash: 141644CBDBC818DF8D7181E319CDB9E0
    @Test()
    ...
    //Sapient generated method id: ${ce6687fc-cef0-3d6d-9e4e-d87d85bf1278}, hash: F8C3DFC8C612E1F09EEEF442ECD1A1F1
    @Test()
    ...
    //Sapient generated method id: ${80959879-1f0d-3c06-960d-0b0db3d257c5}, hash: 598251A4D5B23FB397F4329C55E22157
    @Test()
    ...
    //Sapient generated method id: ${8261d2b4-dfc6-3e2e-af3b-ce3029397f31}, hash: 62BBE3D1BB3632776388FB0CBD7B3689
    @Test()
    ...
    //Sapient generated method id: ${e44f0a7c-c845-3bcc-90a0-76fed77653e7}, hash: F28DF90A738AFD5FFFA427B2A9117729
    @Test()
    ...
    //Sapient generated method id: ${c9d16463-168a-37eb-9dea-81089dd6f5a5}, hash: 87EE8F851A3D1B8A75929818DC94A09C
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${fadc74d5-de00-31a1-ba69-7230f92eb97d}, hash: A87F2F04E0E1F7559F5A81D2039FFCD8
    @Test()
    ...
    //Sapient generated method id: ${547ffcd1-9332-3a47-83ca-88f8b31cf841}, hash: CDE813AD94457F71800CA1893899CBC4
    @Test()
    public void formatWhenSourceInstanceOfMemberAndOmitPrepositionAndNotAppendModuleSource() {
        ...
        try (MockedStatic<StackTraceElements> stackTraceElements = mockStatic(StackTraceElements.class)) {
            ...
            doReturn(formatter).when(formatterMock).format("%s%s\n", objectArray);
            //Act Statement(s)
            target.format();
            //Assert statement(s)
            verify(elementSourceMock).getDeclaringSource();
    ...
    //Sapient generated method id: ${efd37366-f925-3c9d-a481-5b114f87549a}, hash: 72BEF656FD59D3B0635FD9834D30EC13
    @Ignore()
    @Test()
    public void formatWhenSourceInstanceOfMemberAndNotOmitPrepositionAndNotAppendModuleSource() {
        ...
        try (MockedStatic<StackTraceElements> stackTraceElements = mockStatic(StackTraceElements.class)) {
            ...
            Object object = new Object();
            stackTraceElements.when(() -> StackTraceElements.forMember(memberMock)).thenReturn(object);
            SourceFormatter target = new SourceFormatter(elementSourceMock, formatterMock, false);
            Object[] objectArray = new Object[]{"at ", object};
            Formatter formatter = formatterMock.format("%s%s\n", objectArray);
            doReturn(formatter).when(formatterMock).format("%s%s\n", objectArray);
            //Act Statement(s)
            target.format();
            //Assert statement(s)
    ...
    //Sapient generated method id: ${85ed90f2-efae-3095-a416-1ab9843f71c2}, hash: 719730E9B2AFC42CC406841620CD19EF
    @Test()
    ...
    //Sapient generated method id: ${4af50f4f-c1ed-31e7-9b8a-ff85b50d0df6}, hash: 9B3971FD59063938EABB0F547D912FC9
    @Test()
    ...
    //Sapient generated method id: ${9836eab2-d2a6-3bca-8ebe-e3781342f08a}, hash: 5E42E7DDFEA952CA7F3CD56ED4AC34EB
    @Test()
    ...
    //Sapient generated method id: ${d7967f99-1725-3a85-b93c-f383278a63d6}, hash: 9A317A9294E093CFE74A1755B65A5625
    @Test()
    ...
    //Sapient generated method id: ${db03f9fa-07bb-327f-8afb-5ff82f7439e0}, hash: 00E809B723597F1C7F7A92BA4BDC3CC0
    @Test()
    public void formatWhenSourceInstanceOfThreadAndOmitPrepositionAndNotAppendModuleSource() {
        ...
        doReturn(thread).when(elementSourceMock).getDeclaringSource();
        List<String> stringList = new ArrayList<>();
        doReturn(stringList).when(elementSourceMock).getModuleClassNames();
        doReturn(elementSourceMock2, elementSourceMock3).when(elementSourceMock).getOriginalElementSource();
        List<String> stringList2 = new ArrayList<>();
    ...
    //Sapient generated method id: ${504b8cf7-5752-3cef-afb8-989c163b84bb}, hash: 8280DCF41DDF8FFEEA596662C327F6A1
    @Test()
    ...
    //Sapient generated method id: ${6bd834f7-66b7-3b09-86a2-32327804f010}, hash: 1C62557B69184B03CA5F27ECE31F9E21
    @Ignore()
    @Test()
    public void formatWhenSourceNotInstanceOfThreadAndOmitPrepositionAndNotAppendModuleSource() {
         ...
         */
        //Arrange Statement(s)
        ElementSource elementSourceMock = mock(ElementSource.class, "Object");
        doReturn(null).when(elementSourceMock).getDeclaringSource();
        List<String> stringList = new ArrayList<>();
        doReturn(stringList).when(elementSourceMock).getModuleClassNames();
        doReturn(null).when(elementSourceMock).getOriginalElementSource();
        SourceFormatter target = new SourceFormatter(elementSourceMock, formatterMock, true);
    ...
    //Sapient generated method id: ${b0cebd21-0e46-3fcc-837d-09321f93118c}, hash: 5F0011E2936180B4F0686A0316D5C936
    @Test()
    ...
    //Sapient generated method id: ${3135bb39-28f2-37ec-8daa-9cd9890bff87}, hash: C817EC4CBA47067E299B34FE351876B1
    @Test()
    ...
    //Sapient generated method id: ${5f499019-6827-37ae-9bd8-9e17536134b7}, hash: 8FC7458A4F91ACF8C0D80D9F2615526A
    @Test()
    ...
    //Sapient generated method id: ${3364b161-7922-3b39-bbb6-1d6f116b1c5b}, hash: F09CD314AA57663B8673D417EA84378D
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${4872460a-21e8-37d6-b026-f29d1a0b21af}, hash: C693D450CE3F0C45BA636A75BD878E4A
    @Ignore()
    @Test()
    public void getParameterNameWhenSwitchOrdinalModulus10Case1AndParameterNameNotIsEmpty() {
        ...
        try (MockedStatic<Messages> messages = mockStatic(Messages.class)) {
            ...
            doReturn(injectionPointMock).when(dependencyMock).getInjectionPoint();
            doReturn(constructorMock).when(injectionPointMock).getMember();
            messages.when(() -> Messages.redBold("A")).thenReturn("String");
            //Act Statement(s)
            String result = SourceFormatter.getParameterName(dependencyMock);
            //Assert statement(s)
            assertThat(result, equalTo("nullnull parameternull"));
            verify(dependencyMock).getParameterIndex();
            verify(dependencyMock).getInjectionPoint();
            verify(injectionPointMock).getMember();
            messages.verify(() -> Messages.redBold("A"), atLeast(1));
        }
    }

    //Sapient generated method id: ${c107bbd5-82f0-324e-b593-080d54470ad2}, hash: 8F6EBF07C06DA8D6717DEC3B2BE50EBC
    @Ignore()
    @Test()
    public void getParameterNameWhenSwitchOrdinalModulus10Case2AndParameterNameNotIsEmpty() {
        ...
        try (MockedStatic<Messages> messages = mockStatic(Messages.class)) {
            ...
            doReturn(injectionPointMock).when(dependencyMock).getInjectionPoint();
            doReturn(constructorMock).when(injectionPointMock).getMember();
            messages.when(() -> Messages.redBold("A")).thenReturn("");
            //Act Statement(s)
            String result = SourceFormatter.getParameterName(dependencyMock);
            //Assert statement(s)
            assertThat(result, equalTo("2nd parameter "));
            verify(dependencyMock).getParameterIndex();
            verify(dependencyMock).getInjectionPoint();
            verify(injectionPointMock).getMember();
            messages.verify(() -> Messages.redBold("A"), atLeast(1));
    ...
    //Sapient generated method id: ${cfc63e88-e3c3-313b-aecf-81d3e80ad4b1}, hash: 090EEFA992FEEE9152AB96C109C420F5
    @Ignore()
    @Test()
    public void getParameterNameWhenSwitchOrdinalModulus10CaseDefaultAndParameterNameNotIsEmpty() {
        ...
        try (MockedStatic<Messages> messages = mockStatic(Messages.class)) {
            ...
            String result = SourceFormatter.getParameterName(dependencyMock);
            //Assert statement(s)
            assertThat(result, equalTo("1th parameter "));
            verify(dependencyMock).getParameterIndex();
            verify(dependencyMock).getInjectionPoint();
            verify(injectionPointMock).getMember();
            messages.verify(() -> Messages.redBold("A"), atLeast(1));
