...
public class AnnotationsSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${42b79aa8-9fa1-3a51-b6fe-7eeb713c19ec}, hash: 404379C10D917990360F0196243D944A
    @Test()
    ...
    //Sapient generated method id: ${6df746c4-94ba-39d5-aeda-4262a31388fa}, hash: 35AD7C0CF4D5C5B710BA85A33538FD44
    @Ignore()
    @Test()
    public void annotationInstanceClassStringWhenAnnGetDeclaringClassIsNotNull() {
        ...
        //Assert statement(s)
        assertThat(result, equalTo("@A.Object"));
    }

    //Sapient generated method id: ${63723c0a-c7a2-3986-bb3a-1f6c47e25db3}, hash: 2881BA1BED9ED7AF47E71E0965B5714A
    @Test()
    public void annotationInstanceClassStringWhenAnnGetPackageIsNull() {
         ...
         */
        //Act Statement(s)
        //String result = Annotations.annotationInstanceClassString(Object.class, false);
        //Assert statement(s)
        //assertThat(result, equalTo("@java.lang.Object"));
    }

    //Sapient generated method id: ${e4973fbc-107d-323a-9597-b1a39a14fe7d}, hash: 0891E77B70BE35C496C993658F9C6A44
    @Test()
    ...
    //Sapient generated method id: ${d4885230-0da8-3ef4-a84d-72cccadfdfc5}, hash: 4E6DEC44CBBD3C751C1F1970BBBE0CE8
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${40b648a9-9700-3ef5-ba6a-6980079a9296}, hash: 329299379B24656D2C3E3BF99845AFDA
    @Test()
    public void checkForMisplacedScopeAnnotationsWhenContainsComponentAnnotationNotTypeGetAnnotations() {
        ...
        try (MockedStatic<Annotations> annotations = mockStatic(Annotations.class, CALLS_REAL_METHODS);
            ...
            Errors errors = new Errors();
            annotations.when(() -> Annotations.findScopeAnnotation(errors, Object.class)).thenReturn(java.lang.annotation.Annotation.class);
            Annotation[] annotationArray = new Annotation[]{};
            annotations.when(() -> Annotations.containsComponentAnnotation(annotationArray)).thenReturn(false);
            Object object = new Object();
            //Act Statement(s)
            Annotations.checkForMisplacedScopeAnnotations(Object.class, object, errors);
            //Assert statement(s)
            classes.verify(() -> Classes.isConcrete(Object.class), atLeast(1));
            annotations.verify(() -> Annotations.findScopeAnnotation(errors, Object.class), atLeast(1));
    ...
    //Sapient generated method id: ${b14e4cdb-6cdf-3e93-a731-c432eba499ac}, hash: 9F8C0205DCE6E7F8B87EF700D54C56A3
    @Test()
    public void nameOfWhenIsMarkerAnnotationTypeAndKeyGetAnnotationTypeIsNotNull() {
        ...
        try (MockedStatic<Annotations> annotations = mockStatic(Annotations.class, CALLS_REAL_METHODS)) {
            ...
            doReturn(java.lang.annotation.Annotation.class, java.lang.annotation.Annotation.class, Object.class).when(keyMock).getAnnotationType();
