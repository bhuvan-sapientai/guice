...
public class ConstantBindingBuilderImplSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${359c7d51-8821-3932-bcad-1e008633fb34}, hash: 6D777CA5966DE08C2B0AE4544E54F9EF
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${57fd61e1-b7c0-3e49-86b8-94a9495d80e3}, hash: BAB1CD703E609C33D71A7128BB309B31
    @Ignore()
    @Test()
    public void to10WhenKeyTypeIsSet() {
        ...
        doNothing().when(binderMock).addError("Constant value is set more than once.", objectArray);
        //Act Statement(s)
        target.to(DayOfWeek.MONDAY);
        //Assert statement(s)
        verify(target).keyTypeIsSet();
        verify(binderMock).addError("Constant value is set more than once.", objectArray);
    }

    //Sapient generated method id: ${602d252b-39dd-3a03-b272-bb6308e44644}, hash: C91EBE4B2CEFE3E372FE13D301A98F05
    @Ignore()
    @Test()
    public void to10WhenInstanceAsTIsNull() {
        /* Branches:
         * (keyTypeIsSet()) : false  #  inside toConstant method
         * (instanceAsT == null) : true  #  inside toConstant method
         *
