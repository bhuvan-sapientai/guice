...
public class RealOptionalBinderSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${f56d41b4-cf00-3592-bb68-9a89456c3c5f}, hash: 35F4D6F3E28AD22BFB8FD276BDF0CA51
    @Ignore()
    @Test()
    public void configureTest() {
        ...
        ScopedBindingBuilder scopedBindingBuilderMock4 = mock(ScopedBindingBuilder.class, "LinkedBindingBuilder");
        ...
        Key<java.util.Optional<Object>> keyMock6 = mock(Key.class, "Key");
        ScopedBindingBuilder scopedBindingBuilderMock6 = mock(ScopedBindingBuilder.class, "ScopedBindingBuilder");
        ...
        Type typeMock3 = mock(Type.class);
        ...
        Type typeMock5 = mock(Type.class);
        ...
        Type typeMock6 = mock(Type.class);
        TypeLiteral<java.util.Optional<Object>> typeLiteralMock6 = mock(TypeLiteral.class, "TypeLiteral");
        try (MockedStatic<TypeLiteral> typeLiteral = mockStatic(TypeLiteral.class);
             MockedStatic<Types> types = mockStatic(Types.class)) {
            ...
            Class<RealOptionalBinder>[] classArray = new Class[]{RealOptionalBinder.class};
            doReturn(binderMock).when(binderMock3).skipSources(classArray);
            doNothing().when(binderMock).install((Module) any());
            ...
            types.when(() -> Types.newParameterizedType(Optional.class, typeArray2)).thenReturn(parameterizedTypeMock2);
            typeLiteral.when(() -> TypeLiteral.get(parameterizedTypeMock2)).thenReturn(typeLiteralMock);
            Type[] typeArray3 = new Type[]{typeMock2};
            ...
            Type[] typeArray5 = new Type[]{typeMock3};
            ...
            Type[] typeArray7 = new Type[]{typeMock4};
            ...
            Type[] typeArray9 = new Type[]{typeMock5};
            ...
            Type[] typeArray10 = new Type[]{typeMock6};
