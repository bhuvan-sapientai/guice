...
public class BoundProviderFactorySapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${24131180-1b52-321d-8d94-bbb2fdf08388}, hash: 8034D2F3DAA2D358E05135FAF8CB0E74
    @Ignore()
    @Test()
    public void notifyTest() throws ErrorsException {
        ...
        doReturn(internalFactoryMock).when(injectorMock).getInternalFactory((Key) any(), eq(errorsMock), eq(InjectorImpl.JitLimitation.NEW_OR_EXISTING_JIT));
        Errors errors = new Errors();
        //Act Statement(s)
        target.notify(errors);
        //Assert statement(s)
        verify(injectorMock).getInternalFactory((Key) any(), eq(errorsMock), eq(InjectorImpl.JitLimitation.NEW_OR_EXISTING_JIT));
    }

    //Sapient generated method id: ${1fbd76da-f6c0-36a0-80b0-fd764cfa79dc}, hash: 694C28AED9E9CB8182F152CBE4C96B3A
    @Ignore()
    @Test()
