...
public class InitializerSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${90b7eb34-185b-3b88-b415-aaca2c4331b8}, hash: 6BF0041730A6545A2DB3DF549938B0FE
    @Test()
    ...
    //Sapient generated method id: ${a5e00651-7133-3d12-9d66-da4c2b57cbc9}, hash: EBBBC5939AF1AAFD619A8436D3AC6DEB
    @Test()
    public void requestInjectionWhenCachedTypeNotEqualsType() {
        ...
        Errors errors = errorsMock.requestInjectionWithDifferentTypes(object, typeLiteralMock, object2, typeLiteral);
        doReturn(errors).when(errorsMock).requestInjectionWithDifferentTypes(eq(object), eq(typeLiteralMock), eq(object2), (TypeLiteral) any());
        Initializer target = new Initializer();
        ...
        injectionPointSet.add(injectionPoint);
        //Act Statement(s)
        Initializable result = target.requestInjection(injectorImplMock, typeLiteral2, object, binding, object3, injectionPointSet, errorsMock);
        //Assert statement(s)
        assertThat(result, is(notNullValue()));
        verify(errorsMock).requestInjectionWithDifferentTypes(eq(object), eq(typeLiteralMock), eq(object2), (TypeLiteral) any());
    }
