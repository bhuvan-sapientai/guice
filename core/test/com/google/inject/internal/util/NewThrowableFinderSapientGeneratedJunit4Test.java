...
public class NewThrowableFinderSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${da12eda8-142f-3d84-bc2b-5b2c3e08fb0c}, hash: 7051715362053B82502AB32672531E98
    @Test()
    public void findCallerWhenShouldBeSkippedNotTestClassName() {
         ...
         */
        //Arrange Statement(s)
        //doReturn(false).when(shouldBeSkippedMock).test("jdk.internal.reflect.GeneratedConstructorAccessor643");
        ...
        //verify(shouldBeSkippedMock).test("jdk.internal.reflect.GeneratedConstructorAccessor643");
    }

    //Sapient generated method id: ${7ca431db-573d-3ca1-badb-4e8366b29fb0}, hash: DABD3F404C1A152869528B71BA7F82CE
    @Ignore()
    @Test()
    public void findCallerWhenShouldBeSkippedTestClassNameThrowsAssertionError() {
         ...
         */
        //Arrange Statement(s)
        doReturn(true).when(shouldBeSkippedMock).test("jdk.internal.reflect.GeneratedConstructorAccessor643");
