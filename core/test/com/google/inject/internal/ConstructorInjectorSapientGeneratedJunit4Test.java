...
public class ConstructorInjectorSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${cff8da45-d78b-34f0-8f03-f7fdc59d1133}, hash: 052D6A5E13899786E37CDC701D013BB5
    @Ignore()
    @Test()
    public void constructWhenProvisionCallbackIsNotNull() throws InternalProvisionException, InvocationTargetException {
        ...
        java.lang.Object object = provisionCallbackMock.provision(internalContextMock, (ProvisionListenerStackCallback.ProvisionCallback) null);
        ...
        Dependency dependency = Dependency.get(keyMock);
        //Act Statement(s)
        java.lang.Object result = target.construct(internalContextMock, dependency, provisionCallbackMock);
        //Assert statement(s)
        assertThat(result, equalTo(object));
    ...
    //Sapient generated method id: ${67010575-b658-3123-ab39-37b06314161d}, hash: 5D364F1D50742954171018BCB13F3BBA
    @Ignore()
    @Test()
