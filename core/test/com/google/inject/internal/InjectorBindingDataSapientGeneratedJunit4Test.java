...
public class InjectorBindingDataSapientGeneratedJunit4Test {
    ...
    private final ScopeBinding scopeBindingMock = mock(ScopeBinding.class);
    ...
    //Sapient generated method id: ${a64b043e-8277-3b45-9fdc-cfc0749a2a7a}, hash: 955BBE5CF8544AA3B44FD6025C8A8A72
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${4cf42688-151e-312f-9b88-01bf2793b3f5}, hash: AA6BF381B0940AC1B57A7B352749B189
    @Test()
    ...
    //Sapient generated method id: ${937a7c96-6005-34e3-8c57-fe28269aba9e}, hash: 5969D760780EF2B05A602385A55A2507
    @Test()
    public void addInterceptorBindingTest() {
        ...
        //Arrange Statement(s)
        InjectorBindingData target = new InjectorBindingData((Optional) null);
        InterceptorBinding interceptorBindingMock = mock(InterceptorBinding.class, "valid_value");
        //Act Statement(s)
    ...
    //Sapient generated method id: ${abc92e5b-da89-38b0-8342-561e2c3d2827}, hash: 7B77259A71FA8DEB3A5764BA248D1F3A
    @Test()
