...
public class InternalInjectorCreatorSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${4b930eb5-afd0-3a9e-828f-1b6f883b6cbf}, hash: ACD632C6F536844EF83345D7CB414402
    @Test()
    public void addModulesTest() {
        ...
        //Act Statement(s)
        InternalInjectorCreator result = target.addModules(iterable);
        //Assert statement(s)
        assertThat(result, equalTo(target));
    }
