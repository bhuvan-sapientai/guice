...
public class TypeLiteralSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${ded42b2a-da93-3687-a951-9adb44b48dec}, hash: F1227B6A2F6CDF553CDD2F897D757028
    @Ignore()
    @Test()
    public void providerTypeTest() {
         ...
         */
        //Arrange Statement(s)
        TypeLiteral<Provider<Object>> typeLiteralMock = mock(TypeLiteral.class, "TypeLiteral");
    ...
    //Sapient generated method id: ${3c7ba5a6-8718-317d-864b-8c1a1dff12ec}, hash: 9B8D7E8F0084DD54B70ED9C6D65D4B65
    @Ignore()
    @Test()
