...
public class ModulesSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${df6530a8-5bb6-31da-a95b-9cc9f8aa01bf}, hash: 21DC433D7B1A03693C02F3C8AF72151F
    @Test()
    public void override2Test() {
        ...
        //Act Statement(s)
        Modules.OverriddenModuleBuilder result = Modules.override(iterable);

        //Assert statement(s)
        assertThat(result, is(notNullValue()));
    }

    //Sapient generated method id: ${acf56173-551d-3f31-a907-dd506cc7c526}, hash: 88275C4B2A04781A991D9AD5F529ED91
    @Test()
    ...
    Module[][] moduleArray3 = new Module[][] { moduleMock2 };
    Module[] moduleArray2 = new Module[] { moduleArray3 };
    Module[] moduleArray = new Module[] { moduleArray2 };
    //Act Statement(s)
    ...
    //Sapient generated method id: ${5d127df9-5961-3b9c-afcc-50ec8b0302d7}, hash: 012FDF61FDDE0894055623BDA20730CB
    @Test()
    public void combine3Test() {
        ...
        //Act Statement(s)
        Module result = Modules.combine(iterable);
