...
public class ScopesSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${8f34c9b8-8f0d-3c2e-ba17-fe6ce1b7f86d}, hash: D3279BB1D0CC90DC9A045A39B4B69150
    @Test()
    ...
    //Sapient generated method id: ${79f452c8-2922-3571-bec0-b4baf1f7717f}, hash: 1E23561B51095628147B8EEE03421934
    @Test()
    public void isScopedWhenBindingNotInstanceOfExposedBinding() {
         ...
         */
        //Arrange Statement(s)
        Binding bindingMock = mock(Binding.class, "some_value");
        doReturn(false).when(bindingMock).acceptScopingVisitor((BindingScopingVisitor) any());
        Scope scopeMock = mock(Scope.class, "some_value");
        //Act Statement(s)
        boolean result = Scopes.isScoped(bindingMock, scopeMock, Annotation.class);
        //Assert statement(s)
        assertThat(result, equalTo(Boolean.FALSE));
