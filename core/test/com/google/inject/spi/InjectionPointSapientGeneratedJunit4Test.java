...
public class InjectionPointSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${903fef97-987f-323e-a528-d02591a6bcb2}, hash: 9666BA900EAF4BD4863C35536C70BA42
    @Ignore()
    @Test()
    public void getDependenciesTest() throws ErrorsException {
        ...
        try (MockedStatic<Nullability> nullability = mockStatic(Nullability.class);
            ...
            doReturn(true).when(predicateMock).test(0);
    ...
    //Sapient generated method id: ${c2d01f9c-8b7f-3f38-b503-4a78ccaec352}, hash: DB69F87EA61FF321EE126EAF3AA2C47D
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${483432dc-b4bc-3466-aecc-537354b6a1ec}, hash: 5AAEC898AEE8090533E1815BB27E21FA
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${363d3698-f34c-39ad-914f-376a19498023}, hash: 73640221872DAAD9FCC2B1FC735BEACC
    @Ignore()
    @Test()
    public void toStringTest() throws ErrorsException {
         ...
         */
        //Arrange Statement(s)
        Method methodMock = mock(Method.class, "Method");
        KotlinSupportInterface kotlinSupportInterfaceMock = mock(KotlinSupportInterface.class, "KotlinSupportInterface");
    ...
    //Sapient generated method id: ${169d487e-08f6-32da-afb1-d2befbaa712a}, hash: 1EA64C2767D932CAED01AFDE61AAC466
    @Ignore()
    @Test()
    public void forConstructorWhenIsParameterKotlinNullableTestIndex() throws ErrorsException {
         ...
         */
        //Arrange Statement(s)
        KotlinSupportInterface kotlinSupportInterfaceMock2 = mock(KotlinSupportInterface.class, "KotlinSupportInterface");
        try (MockedStatic<Nullability> nullability = mockStatic(Nullability.class);
             MockedStatic<Annotations> annotations = mockStatic(Annotations.class);
             MockedStatic<KotlinSupport> kotlinSupport = mockStatic(KotlinSupport.class);
    ...
    //Sapient generated method id: ${d5d1d185-63e4-3f9b-9789-6a47db27cdd7}, hash: 846948E6971C5899C0767ADEDE7B27C6
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${eb776061-af16-3918-8a8d-cbb2c419a72c}, hash: 6C913CC77F7C2EFDDC88884E76343F18
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${17bf4f5a-6619-3ada-927a-083cb7171c84}, hash: 4AF79CD5309653103EB01DEF398EF5CE
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${4a54f13d-5a15-3a63-8d4d-c2176080da7b}, hash: 90B1798C9248BCB3FE45EEB6E8BD689E
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${9b01874c-8994-3913-b2e7-f945346b9b3b}, hash: D98B58BCD52DB8FC88E8AEE4D1763D06
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${6996458b-3f04-3bcf-b695-51afee4d334f}, hash: 0FBA999DF05155E597F57FFB8AE26F4C
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${c269c104-d53e-3347-b1bb-df88fee35666}, hash: 59ACBFE48A3DB02B1B61ECAD23ACE77E
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${fb99bd95-7373-3ccd-a5ff-164ca5e7a35f}, hash: 31292728846DEAE429747CDADC539E71
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${d817c906-1fb6-3814-a66f-5af550228a91}, hash: FDC7163BD0F464C88A20DE732EF27B7F
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${f68ed3d2-0d17-3daa-8b82-5b9ddad1a12f}, hash: 466015E2AC76F2E921308DFF81DDB91E
    @Test()
    ...
    kotlinSupport.when(() -> KotlinSupport.getInstance()).thenReturn(kotlinSupportInterfaceMock).thenReturn(kotlinSupportInterfaceMock2);
    doReturn(predicateMock).when(kotlinSupportInterfaceMock2).getIsParameterKotlinNullablePredicate((Constructor) any());
    thrown.expect(ConfigurationException.class);
    //Act Statement(s)
    InjectionPoint.forConstructorOf(typeMock, false);
    //Assert statement(s)
    ...
    verify(kotlinSupportInterfaceMock2).getIsParameterKotlinNullablePredicate((Constructor) any());
}*/
    }

    //Sapient generated method id: ${52298a51-bf99-3511-9373-7bb35a10fa02}, hash: 3931C9393A4F9ED1BEDFC3210D51DD35
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${14fb54a8-126d-33a1-a71b-2972fc4e3291}, hash: CE95E46E63B09BED54D17BB26F00D027
    @Test()
    ...
    //Sapient generated method id: ${22fc0292-4376-3a24-b446-140a36275356}, hash: 5FEA5D0A6D29CE904F10D32A623041FC
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${0f8ad4e2-5a5b-33ad-8919-21957aa70d91}, hash: 9A3DD0CD1AE5D392DAB4E1E959EAA53F
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${e89a4ceb-5e0b-304b-afe6-130ed52e0981}, hash: F9227ECF405EA6410DDC863D692D61BF
    @Test()
    ...
    //Sapient generated method id: ${998836ee-96c7-3f3d-859e-277b6a86ac0e}, hash: C1A734B86807EA2B32C238E6198C2A7B
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${82535ab3-0a55-3145-a02c-59883ce08302}, hash: 716591D3D9393A5091C741116B70DEB6
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${9de4cf37-7ed7-3776-bf81-fddd2478656e}, hash: D5EA53DDEBC09E7EE15FE1DDE59A40DA
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${a6f8a75d-9497-3a89-a428-c5a11a5f7e9c}, hash: C93FADF111CADDF0AE13349CF114D295
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${881e8007-480e-3f6b-9cc3-534cefeef418}, hash: AA55835C1E3E31F75A76ED913B78AC14
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${8928e2a5-a484-33e7-8899-bb211dd6accd}, hash: F5A0151CC0AEAF21CEE0ED5B856C0C99
    @Ignore()
    @Test()
    ...
    //Sapient generated method id: ${808e40bd-1442-37bb-a889-d6f965098df0}, hash: 2352B151C71E96F1E3B52C79884D44B8
    @Ignore()
    @Test()
    public void getAtInjectWhenAIsNull() {
         ...
         */
        //Arrange Statement(s)
        AnnotatedElement memberMock = mock(AnnotatedElement.class, "null");
        doReturn(null).when(memberMock).getAnnotation(Inject.class);
        doReturn(null).when(memberMock).getAnnotation(com.google.inject.Inject.class);
        //Act Statement(s)
    ...
    //Sapient generated method id: ${eea66e04-e62c-3268-a509-d93f6759e97a}, hash: 1E6C347BC0950742FD07CB2256873D6C
    @Ignore()
    @Test()
    public void getAtInjectWhenAIsNotNull() {
         ...
         */
        //Arrange Statement(s)
        AnnotatedElement memberMock = mock(AnnotatedElement.class);
    ...
    //Sapient generated method id: ${af8c6de8-b84a-3514-be67-901ef255db78}, hash: CD7754F5B46DFBDC38D6BEBC6AF15219
    @Ignore()
    @Test()
