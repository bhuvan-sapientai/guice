...
public class ElementsSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${08df3e6b-96f3-307d-aa51-0703be59dc55}, hash: ACD79691B2D25777DB59BBA6AEF9B339
    @Test()
    public void getElements2Test() {
        //Arrange Statement(s)
        try (MockedStatic<Elements> elements = mockStatic(Elements.class, CALLS_REAL_METHODS)) {
            List<Element> elementList = new ArrayList<>();
            elements.when(() -> Elements.getElements(Stage.DEVELOPMENT, iterableMock)).thenReturn(elementList);
            //Act Statement(s)
            List<Element> result = Elements.getElements(iterableMock);
            //Assert statement(s)
            assertThat(result, equalTo(elementList));
            elements.verify(() -> Elements.getElements(Stage.DEVELOPMENT, iterableMock), atLeast(1));
        }
    }

    //Sapient generated method id: ${c990c499-761c-3eb2-a696-cf279b327584}, hash: A303B4A7748ABB7B6ED6FF7102543C1C
    @Ignore()
    @Test()
    public void getElements3WhenBinderPrivateBindersForScanningIsNotEmpty() {
         ...
         */
        //Arrange Statement(s)
        Iterable modulesMock = mock(Iterable.class);
        doReturn(null).when(modulesMock).iterator();
        //Act Statement(s)
        List<Element> result = Elements.getElements(Stage.DEVELOPMENT, modulesMock);
        //Assert statement(s)
        assertThat(result.size(), equalTo(0));
        verify(modulesMock).iterator();
    }
    ...
    public void withTrustedSourceWhenBinderInstanceOfRecordingBinder() {
        ...
        //Elements.RecordingBinder elementsRecordingBinderMock = mock(Elements.RecordingBinder.class, "some_value");
    ...
    //Sapient generated method id: ${6e4f2b22-175b-3401-94a6-2cffa5811b72}, hash: 9B26D4D1A34F763B9814D7BD8168A303
    @Ignore()
    @Test()
    public void withTrustedSourceWhenBinderNotInstanceOfRecordingBinder() {
        ...
        GuiceInternal guiceInternalMock = mock(GuiceInternal.class);
        //Act Statement(s)
    ...
    //Sapient generated method id: ${a288d51f-b12e-3796-b615-bd43fb869077}, hash: 1721C5B5D423E60BFF672A811F74A1F8
    @Test()
    public void getModuleTest() {
        //Act Statement(s)
        Module result = Elements.getModule(iterableMock);
        //Assert statement(s)
        assertThat(result, is(notNullValue()));
    }
