...
public class TypeConverterBindingSapientGeneratedJunit4Test {
    ...
    //Sapient generated method id: ${363d3698-f34c-39ad-914f-376a19498023}, hash: C999A88990DE50EEF97705EC68088AAA
    @Ignore()
    @Test()
    public void toStringTest() {
        ...
        try (MockedStatic<Errors> errors = mockStatic(Errors.class)) {
            ...
            //Assert statement(s)
            assertThat(result, equalTo("<init>_typeConverter2 which matches <init>_matcher2 (bound at )"));
